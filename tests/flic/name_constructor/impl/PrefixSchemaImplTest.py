...
from ccnpy.flic.name_constructor.NcSchema import HashSchema, PrefixSchema
...
from ccnpy.flic.name_constructor.impl.PrefixSchemaImpl import PrefixSchemaImpl
